...
@Component({
  ...
  template: `
    <div class="flex items-center justify-center" [class]="containerClass()">
      ...
      <div class="flex space-x-1">
        <div class="w-1 h-6 bg-current rounded animate-pulse" style="animation-delay: 0ms"></div>
        <div class="w-1 h-6 bg-current rounded animate-pulse" style="animation-delay: 150ms"></div>
        <div class="w-1 h-6 bg-current rounded animate-pulse" style="animation-delay: 300ms"></div>
        <div class="w-1 h-6 bg-current rounded animate-pulse" style="animation-delay: 450ms"></div>
      </div>
      } @default {
      <!-- Default spinner -->
      <div class="relative">
        ...
        <div
          class="absolute top-0 left-0 w-8 h-8 border-2 border-current border-t-transparent rounded-full animate-spin"
        ></div>
      </div>
      } } @if (showText() && text()) {
